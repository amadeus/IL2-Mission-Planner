...
### breaks github pages build ###{% include frame.html url="crs-simple-example1.html" %}
...
### breaks github pages build ###{% include frame.html url="crs-simple-example2.html" %}
...
### breaks github pages build ###{% include frame.html url="crs-simple-example3.html" %}
