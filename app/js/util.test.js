...
describe('util', function () {
  ...
  describe('util.defaultPopulateArray', function () {
    ...
    tests.forEach(function (test) {
      it(
        'must return array of length ' + test.expectedLength + ' given ' + test.given.val + ' and ' + test.given.count,
        function () {
  ...
  describe('util.formatFlightLegMarker', function () {
    ...
    var expected =
      '<div style="background: rgba(100, 100, 100, .75); transform: rotate(26deg);">300.0km | 116&deg;/296&deg; <br/> 300kph | ETE 60:00</div>';
    var given = {
      distance: 300,
      heading: 116,
      speed: 300,
    ...
    it(
      ...
      function () {
        assert.strictEqual(
          util.formatFlightLegMarker(given.distance, given.heading, given.speed, given.time, 'metric'),
          expected
        );
      }
    );
